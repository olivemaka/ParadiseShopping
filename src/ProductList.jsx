        ...
        <div>
            <div className="navbar" style={{
                ...
                <div style={{
                    ...
                    <div>
                        <a href="#" onClick={(e) => handlePlantsClick(e)} style={{
                            color: 'white',
                            fontSize: '20px',
                            textDecoration: 'none',
                        }}>Plants</a>
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={{
                            ...
                            <div className="cart-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="30" width="30">
                                    ...
                                    <path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" fill="none" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                                </svg>
                                {totalCartQuantity > 0 && (
